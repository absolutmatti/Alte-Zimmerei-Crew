...
class EventService {
  ...
  // Upload flyer
  Future<String> _uploadFlyer(File file, String eventId) async {
    try {
  ...
  Future<void> deleteEvent(String eventId) async {
    try {
      ...
      // Note: In a production app, you would also delete the flyer from storage
      // and handle related shifts
    } catch (e) {
  ...
  Future<void> togglePublishStatus(String eventId, bool isPublished) async {
    try {
      ...
      throw Exception('Failed to toggle publish status: ${e.toString()}');
    }
  }
}
